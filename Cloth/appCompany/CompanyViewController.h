...
@interface CompanyViewController : UIViewController<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate,UITextFieldDelegate,SGFocusImageFrameDelegate,PullingRefreshTableViewDelegate>
{
    //UI组件
