...
//        PullingRefreshTableView *tableview = (PullingRefreshTableView *)[self.view viewWithTag:TABLETAG];
        ...
        [self getList:nil tableView:myTableview page:1];
...
- (void)buttonSlected:(UIButton *)sender
{
    ...
    if (index == 0) {
        ...
        [self getList:[NSString stringWithFormat:@"%d",index] tableView:myTableview page:1];
    }
...
- (void)createClearView
{
    ...
    //创建搜索栏
//    mySearchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 28, 320, 32)];
...
//    
    ...
    searchField = [[UITextField alloc] initWithFrame:CGRectMake(0, 28, 320, 30)];
...
- (void)createScrollTab
{
    ...
    scrollTab.contentSize = CGSizeMake(400, 26);
...
- (void)createSlideView
{
    ...
    myTableview = [[PullingRefreshTableView alloc] initWithFrame:CGRectMake(0, 200, 320, self.view.frame.size.height-200-44-49) style:UITableViewStylePlain];
